...
var now = new Date();
var apiKey = "351f91287b21e3eaef97ef1db4d5e2ba";
...
h2.innerHTML = "".concat(day, " ").concat(hours, ":").concat(minutes);
...
function searchNow(event) {
  ...
  var apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=".concat(searchInput.value, "&appid=").concat(apiKey, "&units=metric");
  console.log(apiUrl);

  _axios.default.get(apiUrl).then(showWeather);

  var h1 = document.querySelector("h1");
  h1.innerHTML = "".concat(searchInput.value);
}
...
function showWeather(response) {
  ...
  heading.innerHTML = "".concat(temperature, "\xB0C");
  console.log("".concat(city, " ").concat(temperature));
